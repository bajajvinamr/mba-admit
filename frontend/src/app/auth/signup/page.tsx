...
export default function SignUpPage() {
 ...
 <p className="text-sm text-muted-foreground/60 mt-2">Create your account</p>
 </div>
 ...
 <div>
 <label htmlFor="name" className="block text-xs uppercase tracking-wider text-muted-foreground/60 font-bold mb-2">
 Full Name
 </label>
 ...
 <Link href="/auth/signin" className="text-foreground font-bold hover:text-primary transition-colors">
 Sign in
 </Link>
 </p>
 </div>
