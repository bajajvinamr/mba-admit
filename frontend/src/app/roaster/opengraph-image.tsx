...
export const alt = "MBA Resume Roaster - Brutal AI Feedback on Your Resume";
    ...
    (
      ...
      >
        ...
        <div style={{ fontSize: 22, color: "rgba(255,255,255,0.5)", textAlign: "center", marginBottom: 48, maxWidth: 700 }}>
          Get brutally honest AI critique on every bullet point - specificity, impact, and MBA-readiness
        </div>

        {/* Sample critique badges */}
        <div style={{ display: "flex", gap: 16 }}>
          {[
            { emoji: "🔥", label: "Brutal Honesty" },
            { emoji: "🎯", label: "Per-Bullet Critique" },
            { emoji: "📊", label: "Impact Score" },
          ].map((badge) => (
            <div
              key={badge.label}
              style={{
