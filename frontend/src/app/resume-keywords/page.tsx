...
export default function ResumeKeywordsPage() {
 ...
 <span className="text-xs text-foreground/40">{text.split(/\s+/).filter(Boolean).length} words</span>
 ...
 <p className="text-xs text-foreground/40 mt-1">Keyword Score</p>
 </div>
 <div className="editorial-card p-5 text-center">
 <p className="text-4xl font-bold text-foreground">{result.metrics_count}</p>
 <p className="text-xs text-foreground/40 mt-1">Metrics Found</p>
 </div>
 <div className="editorial-card p-5 text-center">
 ...
 <p className="text-xs text-foreground/40 mt-1">Weak Verbs</p>
 </div>
 </div>

 {/* Category breakdown */}
 <div className="editorial-card p-6">
 <h3 className="text-xs font-bold uppercase tracking-widest text-foreground/40 mb-4">Theme Coverage</h3>
 ...
 <span key={kw} className="text-[10px] px-2 py-0.5 bg-foreground/5 text-foreground/40 rounded-full">+ {kw}</span>
 ))}
 </div>
 </div>
 ))}
 ...
 <p className="text-xs text-foreground/40 mb-2">Replace with power verbs:</p>
 ...
 <div className="editorial-card p-6">
 <h3 className="text-xs font-bold uppercase tracking-widest text-foreground/40 mb-3">Recommendations</h3>
