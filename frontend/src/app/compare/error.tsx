...
export default function CompareError({
 ...
 track("error_page", { route:"/compare", message: error.message });
 }, [error]);
 ...
 <h2 className="heading-serif text-3xl text-foreground mb-3">Comparison failed</h2>
 <p className="text-muted-foreground/60 mb-8 leading-relaxed">
 We couldn&apos;t load the school comparison. Try selecting your schools again.
 </p>
 ...
 >
 <GraduationCap size={16} /> Browse Schools
 </Link>
 </div>
 {error.digest && (
