...
import { RefreshCw, Home, Target } from"lucide-react";
...
export default function SimulatorError({
 ...
 track("error_page", { route:"/simulator", message: error.message });
 }, [error]);
 ...
 <h2 className="heading-serif text-3xl text-foreground mb-3">Simulation failed</h2>
 <p className="text-muted-foreground/60 mb-8 leading-relaxed">
 We couldn&apos;t run the odds calculation. This usually means our backend is temporarily unavailable.
 </p>
