...
export default function DashboardError({
 ...
 track("error_page", { route:"/dashboard", message: error.message });
 }, [error]);
 ...
 <h2 className="heading-serif text-3xl text-foreground mb-3">Dashboard unavailable</h2>
 <p className="text-muted-foreground/60 mb-8 leading-relaxed">
 We couldn&apos;t load your dashboard. Your data is safe - try refreshing.
 </p>
