...
export function UsageGate({ feature, children, showBadge = true }: UsageGateProps) {
 const { isAtLimit, remaining, isUnlimited, limit, period, featureLabel, upgradeNeeded, tier } = useUsage(feature);
 ...
 // Under limit - render with optional badge
 const isLastUse = remaining === 1;
 return (
 <div>
 {showBadge && !isUnlimited && (
