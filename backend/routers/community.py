...
def admit_simulator(req: SimulatorRequest):
    ...
    for sid in school_ids:
        ...
        gmat_factor = gmat_diff * 0.3
        expected_gpa = 3.6
        gpa_diff = req.gpa - expected_gpa
        gpa_factor = gpa_diff * 15
        accept_rate = 30.0
        try:
        ...
        ci_low = round(sorted_probs[4], 1)
        ci_high = round(sorted_probs[94], 1)
